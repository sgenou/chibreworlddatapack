...
# # Téléportation
# execute as @a[scores={sneaking=1..},nbt={SelectedItem: {id: "minecraft:feather", tag: {display: {Name: '{"text":"Plume de regroupement"}'}, Enchantments: [{lvl: 1s, id: "minecraft:unbreaking"}]}}}] if entity @a[scores={sneaking=1.., nbtTest=0, nbtTest2=0},nbt={SelectedItem: {id: "minecraft:feather"}}] run tp @a[scores={sneaking=1.., nbtTest=0, nbtTest2=0},nbt={SelectedItem: {id: "minecraft:feather"}}] @s
