...
execute if block ~ ~ ~ #minecraft:signs run data merge block ~ ~ ~ {Text1: "{\"text\":\"\",\"color\":\"dark_red\",\"bold\":\"true\",\"clickEvent\":{\"action\":\"run_command\",\"value\":\"/execute at @p[distance=..2] run tp @p[distance=..2] ~ ~8 ~\"}}", Text2: "{\"text\":\"^\",\"color\":\"dark_red\",\"bold\":\"true\"}", Text3: "{\"text\":\"|\",\"color\":\"dark_red\",\"bold\":\"true\"}", Text4: "{\"text\":\"\",\"color\":\"red\"}", id: "Sign"}
...
execute if entity @p[scores={cast_up8=12..}] run scoreboard players set @p[scores={cast_up8=12..}] cast_up8 0
# Si on ne trouve pas on avance
execute unless block ~ ~ ~ #minecraft:signs if block ~ ~ ~ minecraft:air if entity @p[scores={cast_up8=1..}] run scoreboard players add @p[scores={cast_up8=1..}] cast_up8 1
execute unless block ~ ~ ~ #minecraft:signs if block ~ ~ ~ minecraft:air positioned ^ ^ ^1 run function chibreworld:lifts/cast_up8