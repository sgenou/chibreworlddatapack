...
# Objet du marchand
#{maxUses: 1000000, buy: {id: "diamond", Count: 64}, sell: {id: "minecraft:written_book", tag: {pages: ['["",{"text":"La légende du chevalier fantôme\\n--------------","bold":true,"italic":true},{"text":"\\nIl y a très, très longtemps, un chevalier défendait tous ceux qui avaient besoin de son aide...\\n ","color":"reset"}]', '["",{"text":"La légende raconte qu\'on peut encore l\'appercevoir si on pose ce livre sur un pupitre, qu\'on place un porte armure équipé derrière ce pupitre et qu\'on clique sur cette formule:\\n"},{"text":"SAALIMBA GOSTENAIIT","color":"gold","clickEvent":{"action":"run_command","value":"/trigger gk_totem_set"}}]'], title: "La légende du chevalier fantôme", author: "ChibWorld Legends", generation: 2, display: {Lore: ['"Le livre de la légende du chevalier fantôme."']}}, Count: 1}, rewardExp: false, Paper.IgnoreDiscounts: 1b}