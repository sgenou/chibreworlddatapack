...
execute at @p[scores={cst_bank_display=1..},nbt={SelectedItem: {id: "minecraft:written_book", tag: {title: "Livre d'installation de banque"}}}] run function chibreworld:bank/cast_bank_display
execute at @p[scores={cst_bank_deposit=1..},nbt={SelectedItem: {id: "minecraft:written_book", tag: {title: "Livre d'installation de banque"}}}] run function chibreworld:bank/cast_bank_deposit
execute at @p[scores={cst_coal_wthdraw=1..},nbt={SelectedItem: {id: "minecraft:written_book", tag: {title: "Livre d'installation de banque"}}}] run function chibreworld:bank/cast_coal_withdrawal
execute at @p[scores={cst_iron_wthdraw=1..},nbt={SelectedItem: {id: "minecraft:written_book", tag: {title: "Livre d'installation de banque"}}}] run function chibreworld:bank/cast_iron_withdrawal
execute at @p[scores={cst_gold_wthdraw=1..},nbt={SelectedItem: {id: "minecraft:written_book", tag: {title: "Livre d'installation de banque"}}}] run function chibreworld:bank/cast_gold_withdrawal
execute at @p[scores={cst_diam_wthdraw=1..},nbt={SelectedItem: {id: "minecraft:written_book", tag: {title: "Livre d'installation de banque"}}}] run function chibreworld:bank/cast_diamond_withdrawal
