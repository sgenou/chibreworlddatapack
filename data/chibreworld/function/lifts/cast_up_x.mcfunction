...
execute if block ~ ~ ~ #minecraft:signs if items entity @p weapon.mainhand minecraft:written_book run clear @p[scores={cast_upX=1..}] minecraft:written_book[custom_data~{lifts_book:1b}] 1
