...
execute if block ~ ~ ~ #minecraft:signs if items entity @p weapon.mainhand minecraft:written_book run clear @p[scores={cast_upX=1..}] minecraft:written_book[written_book_content~{title:"Livre des ascenseurs",author:"sgenou le magicien"}] 1
