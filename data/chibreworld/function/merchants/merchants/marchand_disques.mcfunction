...
execute at @e[type=minecraft:villager,tag=spwnDiscMerchant] run data merge entity @e[type=minecraft:villager,tag=spwnDiscMerchant,distance=..1,limit=1] {VillagerData: {profession: "minecraft:librarian"}, CustomName: '"Marchand de disques"', Offers: {Recipes: [\
