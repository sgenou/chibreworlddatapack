...
execute at @e[type=minecraft:villager,tag=spwnFleuriste] run data merge entity @e[type=minecraft:villager,tag=spwnFleuriste,distance=..1,limit=1] {VillagerData: {profession: "minecraft:farmer"}, CustomName: '"Fleuriste"', Offers: {Recipes: [\
