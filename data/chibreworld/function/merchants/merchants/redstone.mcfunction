...
execute at @e[type=minecraft:villager,tag=spwnRaidstone] run data merge entity @e[type=minecraft:villager,tag=spwnRaidstone,distance=..1,limit=1] {VillagerData: {profession: "minecraft:mason"}, CustomName: '"Marchand de redstone"', Offers: {Recipes: [\
