...
execute at @e[type=minecraft:armor_stand,sort=nearest,tag=diamond_withdrawal_zone] run data merge block ~ ~ ~ {\
    front_text: {has_glowing_text: 0b, color: "dark_red", messages: [{"color":"dark_red","click_event":{"action":"run_command","command":"/scoreboard players set @p wantDiamondBlock 1"},"text":"Retrait"}, {"color":"dark_red","click_event":{"action":"run_command","command":"/scoreboard players set @p wantDiamondBlock 1"},"text":"1 bloc"},{"color":"dark_red","click_event":{"action":"run_command","command":"/scoreboard players set @p wantDiamondBlock 1"},"text":"de diamant"}, ""]}, is_waxed: 1b,\
}
...
execute at @e[type=minecraft:armor_stand,sort=nearest,tag=gold_withdrawal_zone] run data merge block ~ ~ ~ {\
    front_text: {has_glowing_text: 0b, color: "dark_red", messages: [{"color":"dark_red","click_event":{"action":"run_command","command":"/scoreboard players set @p wantGoldBlock 1"},"text":"Retrait"}, {"color":"dark_red","click_event":{"action":"run_command","command":"/scoreboard players set @p wantGoldBlock 1"},"text":"1 bloc"},{"color":"dark_red","click_event":{"action":"run_command","command":"/scoreboard players set @p wantGoldBlock 1"},"text":"d\'or"}, ""]}, is_waxed: 1b,\
}
...
execute at @e[type=minecraft:armor_stand,sort=nearest,tag=iron_withdrawal_zone] run data merge block ~ ~ ~ {\
    front_text: {has_glowing_text: 0b, color: "dark_red", messages: [{"color":"dark_red","click_event":{"action":"run_command","command":"/scoreboard players set @p wantIronBlock 1"},"text":"Retrait"}, {"color":"dark_red","click_event":{"action":"run_command","command":"/scoreboard players set @p wantIronBlock 1"},"text":"1 bloc"},{"color":"dark_red","click_event":{"action":"run_command","command":"/scoreboard players set @p wantIronBlock 1"},"text":"de fer"}, ""]}, is_waxed: 1b,\
}
...
execute at @e[type=minecraft:armor_stand,sort=nearest,tag=coal_withdrawal_zone] run data merge block ~ ~ ~ {\
    front_text: {has_glowing_text: 0b, color: "dark_red", messages: [{"color":"dark_red","click_event":{"action":"run_command","command":"/scoreboard players set @p wantCoalBlock 1"},"text":"Retrait"}, {"color":"dark_red","click_event":{"action":"run_command","command":"/scoreboard players set @p wantCoalBlock 1"},"text":"1 bloc"},{"color":"dark_red","click_event":{"action":"run_command","command":"/scoreboard players set @p wantCoalBlock 1"},"text":"de charbon"}, ""]}, is_waxed: 1b,\
}
